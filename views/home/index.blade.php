...
<body id="kt_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu"
    data-bs-offset="200" class="bg-white position-relative">
    <!--begin::Main-->
                                    ...
                                    <div class="menu menu-column flex-nowrap menu-rounded menu-lg-row menu-title-gray-500 menu-state-title-primary nav nav-flush fs-5 fw-bold"
                                        ...
                                        <div class="menu-item">
                                            ...
                                            <a class="menu-link nav-link active py-3 px-4 px-xxl-6"
                                                ...
                                                data-kt-drawer-dismiss="true">HR
                                                and Project Mgt</a>
                                            <!--end::Menu link-->
                                        </div>
                                        <!--end::Menu item-->
                                        ...
                                        <div class="menu-item">
                                            ...
                                            <a class="menu-link nav-link py-3 px-4 px-xxl-6"
                                                href="{{ url('/login') }}"
                                                data-kt-scroll-toggle="true"
                                                data-kt-drawer-dismiss="true">Procurement
                                                and Inventory</a>
                                            <!--end::Menu link-->
                                        </div>
                                        <!--end::Menu item-->
                                        ...
                                        <div class="menu-item">
                                            ...
                                            <a class="menu-link nav-link py-3 px-4 px-xxl-6"
                                                href="{{ url('/login') }}"
                                                data-kt-scroll-toggle="true"
                                                data-kt-drawer-dismiss="true">Analytics</a>
                                            <!--end::Menu link-->
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item">
                                            <!--begin::Menu link-->
                                            <a class="menu-link nav-link py-3 px-4 px-xxl-6"
                                                href="http://ECSA-HC.kh/"
                                                data-kt-scroll-toggle="true"
                                                data-kt-drawer-dismiss="true">Knowledge
                                                Hub</a>
                                            <!--end::Menu link-->
                                        </div>
                                        <!--end::Menu item-->
                ...
                <div
                    ...
                    <div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
                        ...
                        <h1
                            ...
                            ECSA-HC Enterprise Modular Cloud
                            <br />
                            <span
                                style="background: linear-gradient(to right, #12CE5D 0%, #FFD80C 100%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">
                                <span id="kt_landing_hero_text">Management
